...
Summary(pl.UTF-8):   submerge - wizualne narzędzie do porównywania i łączenia plików tekstowych
Group:		X11/Applications
...
submerge to wizualne narzędzie do porównywania i łączenia plików
tekstowych.
